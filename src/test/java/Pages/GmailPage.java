...
public class GmailPage extends BaseUtil
{
    ...
    {
        waitUtil.waitForVisible(gotIt).click();
    }

    public void clickTakeMeToGmail()
    {
        waitUtil.waitForVisible(takeMeToGmail).click();
    }
    ...
    {
        waitUtil.waitForVisible(gotIt_HomePage).click();
    }
    ...
    {
        waitUtil.waitForVisible(toMail).clear();
        waitUtil.waitForVisible(toMail).sendKeys(to);
    }

    public void clickSuggestion()
    {
        waitUtil.waitForVisible(mailSuggestion).click();
    }

    public void enterSubject(String subject)
    {
        waitUtil.waitForVisible(subjectMail).clear();
        waitUtil.waitForVisible(subjectMail).sendKeys(subject);
    }

    public void clickSend()
    {
        waitUtil.waitForVisible(send).click();
    }
    ...
    {
        waitUtil.waitForVisible(meet).click();
    }
    ...
    {
        waitUtil.waitForVisible(newMeeting).click();
    }
    ...
    public void clickNavigationMenu() throws InterruptedException {
        waitUtil.waitForVisible(navigationMenu).click();
        Thread.sleep(2000);
    }

    public void clickSettings()
    {
        waitUtil.waitForVisible(settings).click();
    }

    public void clickGeneralSettings()
    {
        waitUtil.waitForVisible(generalSettings).click();
    }
    ...
    {
        waitUtil.waitForVisible(light).click();
    }
