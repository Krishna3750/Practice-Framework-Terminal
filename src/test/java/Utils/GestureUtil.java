...
public class GestureUtil
{
    ...
    public int xCoordinate_Center_Of_Element(WebElement element)
    {
    ...
    public int yCoordinate_Center_Of_Element(WebElement element)
    {
    ...
    {
        int centerX = xCoordinate_Center_Of_Element(element);
        int centerY = yCoordinate_Center_Of_Element(element);
        ...
        seq.addAction(new Pause(finger,Duration.ofMillis(400)));
