...
public class MyListener implements ITestListener
{
    ...
    public Map<String, ExtentTest> methods = new HashMap<>();
    ...
    public void onStart(ITestContext context)
    {
        if(extentReports==null)
        {
            ...
            extentSparkReporter = new ExtentSparkReporter(System.getProperty("user.dir")+"/ExtentReports/Reports/Report("+reportTime+").html");
            extentSparkReporter.config().setDocumentTitle("Listeners_ExtentReports_Framework");
            extentSparkReporter.config().setReportName("Gmail Test");
        ...
        {
            methods.put(deviceName,extentReports.createTest(deviceName));
        }
    }
    ...
    public void onTestStart(ITestResult result)
    {
        ...
        ExtentTest deviceNode = methods.get(deviceName);
